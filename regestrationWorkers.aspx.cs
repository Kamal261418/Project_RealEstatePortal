...
using System.IO;
public partial class regestrationWorkers : System.Web.UI.Page
{
...
FileUpload1.SaveAs(Server.MapPath("userimage/" + filename));
            ...
            cmd.Connection = con;
            cmd.CommandText = "INSERT INTO workersReg (workerName,workerBirthDate,workerCountry,workerPhone,workerEmail,workerPassword,Repassword,workerPhoto)values(@workerName,@workerBirthDate,@workerCountry,@workerPhone,@workerEmail,@workerPassword,@Repassword,@workerPhoto)";
            SqlParameter p1 = new SqlParameter("@workerName", TxtBoxName.Text);
            SqlParameter p2 = new SqlParameter("@workerBirthDate", Label1.Text);
            SqlParameter p3 = new SqlParameter("@workerCountry", TxrBoxCoun.Text);
            SqlParameter p4 = new SqlParameter("@workerPhone", TxtboxPhonr.Text);
            SqlParameter p5 = new SqlParameter("@workerEmail", TxtBoxEmail.Text);
            SqlParameter p6 = new SqlParameter("@workerPassword", TxtBoxPWD.Text);
            SqlParameter p7 = new SqlParameter("@Repassword", TxtBoxRePWD.Text);
            SqlParameter p8 = new SqlParameter("@workerPhoto", "userimage/" + filename);
        ...
        else if (RadioButtonList1.SelectedIndex == 1)
        {
            ...
            Label5.Text = "من فضلك اختار الفئه التى تنتمى اليها"; 
        }
    }
